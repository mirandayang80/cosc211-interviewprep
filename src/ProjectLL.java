...
public class ProjectLL {
    ...
    static DoublyLinkedList QA = new DoublyLinkedList();
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (screen == 1) {
                ...
                //add the question onto the review answers LL
                QA.addQ(qu);
...
//                    System.out.println(x2 + " " + y2);
                ...
                Node temp = QA.getFirst();

                //get every q&a until array is empty
                for (int i =0; i < QA.size(); i++) {
                    String answer = temp.getAnswer();
                    String qs = temp.getQuestion();

                    //only print non-empty q & a pairs
    ...
    public static String question(int category) {
        ...
        //randomly pick a question from the linked list
        int llSize = LL.size();
        Random rnd = new Random();
        int qNum = rnd.nextInt(llSize);


        //get the qNumth Node from the list
        String q = "";
        int i = 0;
